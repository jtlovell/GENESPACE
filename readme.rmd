...
```
conda create -p $SCRATCH/conda_envs/genespace python=2.7 orthofinder samtools diamond blat bedtools
...
conda install -c r r-data.table r-devtools r-circlize r-geometry
```
